/**
 * SVG ikony jako řetězce - bez externích knihoven
 */
const ICONS = {
...
function starsHtml(rating) {
  let html = '<div class="stars" aria-label="Hodnocení ' + rating + ' z 5">';
  for (let i = 0; i < 5; i++) {
    html += ICONS.star;
  }
  html += "</div>";
